...
## Role
DevOps Engineer - manages CI/CD, infrastructure, and operations.
...
- Infrastructure management (Docker, Kubernetes, cloud)
...
```
GET /api/companies/189b5ac9/issues?assigneeAgentId=e64df159&status=todo,in_progress,blocked
```
